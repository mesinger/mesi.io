...
{
    public class ExceptionHandlingMiddleWareDev
    {
        private readonly RequestDelegate _next;

        public ExceptionHandlingMiddleWareDev(RequestDelegate next)
        {
            _next = next;
        }
        ...
        private void HandleException(HttpContext context, Exception ex)
        {
            ...
            switch (ex)
            {
                ...
                case InvalidInputException _:
                    ...
                    break;
                default:
                    msg = JsonConvert.SerializeObject(new {trace = ex.StackTrace, message = ex.Message});
                    code = 500;
                    break;
            }
